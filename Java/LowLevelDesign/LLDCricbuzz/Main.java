...
public class Main {
    public static void main(String args[]){
        // we can create obj of same class in class function (its refernce)
        // it would not create a loop, as main function is executed/call only once
        Main ob = new Main();
        Team teamA = ob.addTeam("TeamA");
        Team teamB = ob.addTeam("TeamB");

        MatchType matchType = new T20MatchType();
        Match match = new Match(teamA, teamB, null, "Delhi Stadium", matchType);
        match.startMatch();
    }
